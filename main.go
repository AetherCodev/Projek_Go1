...
func parseTemplates() (*template.Template, error) {
	...
	subDirs := map[string]string{
		...
		"templates/admin/tambah_produk.html": "admin/tambah_produk.html",
	}
...
func main() {
	...
	r.HandleFunc("/admin/tambah_produk", admin.RenderAdminTambah).Methods("GET")
	r.HandleFunc("/admin/tambah_produk", admin.AdminTambah).Methods("POST")
